...
require_once 'includes/editClient.php';
...
<div id="overlay">
    ...
    <section id="editClientSection">
        <div>
            <img src="stylesheets/icon/circle-xmark-solid.svg" id="exitEditClientBtn" class="closeBtn"/>
        </div>
        <form method="post" class="greyInput">
            <h1>Nieuwe klant toevoegen</h1>
            <input type="text" id="originalName" name="originalName" hidden/>
            <label for="clientName">Naam klant</label>
            <input type="text" id="clientNameEdit" name="clientNameEdit" placeholder="Naam klant"/>
            <?= $clientError ?><br/>
            <label for="clientPhone">Telefoonnummer</label>
            <input type="tel" id="clientPhoneEdit" name="clientPhoneEdit" placeholder="06 12 34 56 78"><br/>
            <label for="clientEmailEdit">E-mail</label>
            <input type="email" id="clientEmailEdit" name="clientEmailEdit" placeholder="voorbeeld@email.com"
                   pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"/><br/>
            <div>
                <input type="submit" name="clientEditSbmt" value="Voeg toe"/>
            </div>
        </form>
    </section>
</div>
